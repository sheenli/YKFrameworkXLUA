...
namespace XLua.CSObjectWrap
{
    ...
    public class ParallelTaskWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ParallelTask);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 4 && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2) && translator.Assignable<System.Action>(L, 3) && translator.Assignable<System.Action<string, string>>(L, 4))
				{
					...
					ParallelTask __cl_gen_ret = new ParallelTask(failureStop, finished, failure);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ParallelTask constructor!");
        ...
        static int _m_OnExecute(RealStatePtr L)
        {
		    try {
                ...
                ParallelTask __cl_gen_to_be_invoked = (ParallelTask)translator.FastGetCSObj(L, 1);
