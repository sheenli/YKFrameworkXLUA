    ...
    public class FairyGUIGObjectWrap 
    {
        ...
        static int _m_SetXY(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    float xv = (float)LuaAPI.lua_tonumber(L, 2);
                    float yv = (float)LuaAPI.lua_tonumber(L, 3);
                    bool topLeftValue = LuaAPI.lua_toboolean(L, 4);
                    
                    __cl_gen_to_be_invoked.SetXY( xv, yv, topLeftValue );
        ...
        static int _g_get_pivotAsAnchor(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GObject __cl_gen_to_be_invoked = (FairyGUI.GObject)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.pivotAsAnchor);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_packageItem(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GObject __cl_gen_to_be_invoked = (FairyGUI.GObject)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.packageItem);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_pivotAsAnchor(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GObject __cl_gen_to_be_invoked = (FairyGUI.GObject)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.pivotAsAnchor = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_packageItem(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GObject __cl_gen_to_be_invoked = (FairyGUI.GObject)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.packageItem = (FairyGUI.PackageItem)translator.GetObject(L, 2, typeof(FairyGUI.PackageItem));
