...
namespace XLua.CSObjectWrap
{
    ...
    public class GetGPSFinishEventGPSLocationInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(GetGPSFinishEvent.GPSLocationInfo);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(GetGPSFinishEvent.GPSLocationInfo));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GetGPSFinishEvent.GPSLocationInfo constructor!");
        ...
        static int _g_get_longitude(RealStatePtr L)
        {
		    try {
                ...
                GetGPSFinishEvent.GPSLocationInfo __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
