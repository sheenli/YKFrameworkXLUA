    ...
    public class FairyGUICaptureCameraWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.CaptureCamera __cl_gen_ret = new FairyGUI.CaptureCamera();
        ...
        static int _m_CreateRenderTexture_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    bool stencilSupport = LuaAPI.lua_toboolean(L, 3);
                    
                        UnityEngine.RenderTexture __cl_gen_ret = FairyGUI.CaptureCamera.CreateRenderTexture( width, height, stencilSupport );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_Capture_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    FairyGUI.DisplayObject target = (FairyGUI.DisplayObject)translator.GetObject(L, 1, typeof(FairyGUI.DisplayObject));
                    UnityEngine.RenderTexture texture = (UnityEngine.RenderTexture)translator.GetObject(L, 2, typeof(UnityEngine.RenderTexture));
                    UnityEngine.Vector2 offset;translator.Get(L, 3, out offset);
                    
                    FairyGUI.CaptureCamera.Capture( target, texture, offset );
        ...
        static int _g_get_cachedTransform(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.CaptureCamera __cl_gen_to_be_invoked = (FairyGUI.CaptureCamera)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_cachedTransform(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.CaptureCamera __cl_gen_to_be_invoked = (FairyGUI.CaptureCamera)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.cachedTransform = (UnityEngine.Transform)translator.GetObject(L, 2, typeof(UnityEngine.Transform));
        ...
        static int _s_set_cachedCamera(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.CaptureCamera __cl_gen_to_be_invoked = (FairyGUI.CaptureCamera)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.cachedCamera = (UnityEngine.Camera)translator.GetObject(L, 2, typeof(UnityEngine.Camera));
