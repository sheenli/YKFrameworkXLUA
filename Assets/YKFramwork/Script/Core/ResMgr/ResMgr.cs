...
#region 加载一个资源组
    ...
    {
        LoadGroup(GameCfgMgr.Instance.GetGroupInfo(groupName), groupName);
    }
    ...
    public void LoadGroup(ResGroupCfg groupData,string groupName)
    {
        if (groupData == null)
        {
        ...
        {
            new LoadGroup(groupData).Load(null);
        }
    }
#endregion
