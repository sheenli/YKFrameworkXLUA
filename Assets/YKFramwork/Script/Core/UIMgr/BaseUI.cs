...
{
    public EventListenerMgr eventMgr = new EventListenerMgr();
    ...
    public void AddListener(string type, EventDispatcherNode dis
       , int _priority = 0, bool _dispatchOnce = false)
    {
        eventMgr.AddListener(dis,this.OnHandler, type, _priority, _dispatchOnce);
    }
    ...
    protected virtual void OnBtnClick(FairyGUI.GButton btn)
    {
